...
try:
    ...
    # Create mapping between friendly names and dataset names
    for symptom in symptoms_dict:
        friendly_name = symptom.replace('_', ' ')
        friendly_to_dataset[friendly_name] = symptom
        dataset_to_friendly[symptom] = friendly_name
...
def get_predicted_value(patient_symptoms):
    ...
    # Filter valid symptoms (should already be in dataset format)
